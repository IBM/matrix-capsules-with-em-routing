#!/bin/sh
python3 train_val.py --dataset=mnist --batch_size=64 --A=16 --B=4 --C=8 --D=8 --drop_rate=0.5 --dropout=True --dropconnect=True --affine_voting=True --num_gpus=1 --epoch=15 --logdir=dropconn
