#!/bin/sh
python3 train_val.py --dataset=mnist --batch_size=64 --A=16 --B=4 --C=8 --D=8 --drop_rate=0.5 --dropconnect=True --recon_loss=True --recon_loss_lambda=1 --num_gpus=1 --epoch=15 --logdir=recon
