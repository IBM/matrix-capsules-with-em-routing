#!/bin/sh
# python3 train_val.py --dataset=mnist --batch_size=256 --A=64 --B=8 --C=16 --D=16 --drop_rate=0.5 --dropout=False --dropconnect=False --recon_loss=True --num_gpus=2 --epoch=30 --logdir=recon
